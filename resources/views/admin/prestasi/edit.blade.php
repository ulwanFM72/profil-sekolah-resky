...
@section('content')
    ...
    <div class="admin-form-card">
        <h6 class="mb-4">Edit Prestasi</h6>
        <form action="{{ route('admin.prestasi.update', $prestasi->id) }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-4">
                    ...
                    <input type="number" name="tahun" class="form-control" value="{{ old('tahun', $prestasi->tahun) }}" required min="2000" max="2100">
                </div>
                <div class="col-md-6">
                    <label class="form-label">Nama Siswa (opsional)</label>
                    <input type="text" name="nama_siswa" class="form-control" value="{{ old('nama_siswa', $prestasi->nama_siswa) }}">
                </div>
                <div class="col-md-3">
                    <label class="form-label">Kategori</label>
                    <select name="kategori" class="form-select" required>
                        <option value="Akademik" @selected(old('kategori', $prestasi->kategori)==='Akademik')>Akademik</option>
                        <option value="Non Akademik" @selected(old('kategori', $prestasi->kategori)==='Non Akademik')>Non Akademik</option>
                    </select>
                </div>
                <div class="col-md-3">
                ...
                <div class="col-md-12">
                    ...
                    @if($prestasi->gambar)
                        <img src="{{ asset('storage/'.$prestasi->gambar) }}" class="current-image-preview" id="previewImg">
                    @else
            ...
            <div class="d-flex gap-2 mt-4">
                ...
                <a href="{{ route('admin.prestasi.index') }}" class="btn btn-cancel rounded-pill px-4">Kembali</a>
            </div>
        </form>
    </div>

...
@section('content')
    ...
    <div class="admin-form-card">
        <h6 class="mb-4">Tambah Data Guru / Staff</h6>
        <form action="{{ route('admin.guru.store') }}" method="POST" enctype="multipart/form-data">
            ...
            <div class="row g-3">
                ...
                <div class="col-md-6">
                    ...
                    <input type="text" name="jabatan" class="form-control" value="{{ old('jabatan') }}" required placeholder="Contoh: Guru Produktif RPL">
                </div>
                <div class="col-md-6">
            ...
            <div class="d-flex gap-2 mt-4">
                ...
                <a href="{{ route('admin.guru.index') }}" class="btn btn-cancel rounded-pill px-4">Batal</a>
            </div>
        </form>
    </div>

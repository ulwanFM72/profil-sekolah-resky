                    ...
                    <div class="col-lg-4 col-md-6" data-aos="fade-up" data-aos-delay="{{ ($i % 3) * 100 }}">
                        <div class="news-card">
                            <div class="news-thumb-wrap">
                                <img src="{{ $item->thumbnail ? asset('storage/'.$item->thumbnail) : 'https://placehold.co/500x300/1E3A8A/FFFFFF?text=Berita' }}" alt="{{ $item->judul }}" class="news-thumb">
                            ...
                            <div class="news-body">
                                ...
                                <a href="{{ route('news.show', $item->slug) }}" class="news-link">Baca Selengkapnya <i class="bi bi-arrow-right"></i></a>
                            </div>
                        </div>
                    </div>
                @empty
